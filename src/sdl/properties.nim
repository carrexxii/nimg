...
proc get_x11_screen_number*  (window: Window): Property = get_property(get_window_property(window), PropX11ScreenNumber  , nil)
proc get_x11_window_number*  (window: Window): Property = get_property(get_window_property(window), PropX11WindowNumber  , nil)
